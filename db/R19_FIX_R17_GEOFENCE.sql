-- R19 FIX: R17_GEOFENCE.sql
-- Original error: relation "public.pos_branches" does not exist
-- Fix: pos_branches creada en R19_PREFLIGHT; aquí solo el contenido específico.
...
DECLARE r constant double precision := 6371000;
        d_lat double precision; d_lng double precision; a double precision;
BEGIN
