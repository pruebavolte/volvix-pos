...
- **Emulador `emulator-5556` (Android 10, 1080x2280, 393x830 CSS px), APK real de CI** (evidencia 2026-09-20):
  ...
  - Camara: `scanBarcode` muestra overlay y oculta el resto; el vista previa del emulador sale negra (sin decodificar codigos aqui; falta probar en equipo fisico). Bug hallado y corregido: `stopScan()` no resuelve `startScan()`, asi que "Cancelar" ahora cierra por su cuenta (verificado).
