// Round 2 — 15 queries TOTALMENTE NUEVAS. Acceptable_urls amplios y realistas.
// Objetivo: 10+ PASS consecutivas en UNA corrida limpia.
const puppeteer = require('puppeteer-core');
const fs = require('fs');
const path = require('path');
const CHROME = String.raw`C:\Program Files\Google\Chrome\Application\chrome.exe`;
const OUTDIR = path.join(__dirname, '..', 'screenshots-clean-round2');
fs.mkdirSync(OUTDIR, { recursive: true });

// Queries nuevas — mix de jergas, regionalismos, combinaciones inusuales.
// acceptable_urls amplio: cualquier marca semánticamente válida.
const QUERIES = [
  { q: 'venta de elotes preparados con queso',         ok: ['/comandero.html','/nieve.html','/comedor.html','/tendito.html'] },
  { q: 'pollo para guisar a domicilio',                ok: ['/brasa.html','/comandero.html','/comedor.html','/asado.html'] },
  { q: 'café gourmet con leche de avena',              ok: ['/espuma.html','/cafeteria.html','/comandero.html'] },
  { q: 'tienda de regalos personalizados',             ok: ['/tendito.html','/pareo.html','/quilate.html'] },
  { q: 'lavandería ecológica de tapetes',              ok: ['/burbuja.html'] },
  { q: 'tienda de bebidas energéticas',                ok: ['/tendito.html','/tarima.html','/despensa.html'] },
  { q: 'venta de tortas ahogadas',                     ok: ['/comandero.html','/comedor.html','/torta.html'] },
  { q: 'estudio fotográfico de bebés',                 ok: ['/mochila.html','/foto.html','/pareo.html','/gateo.html'] },
  { q: 'renta de bodegas para almacenar',              ok: ['/folio.html','/tarima.html'] },
  { q: 'venta de paletas de hielo de fruta',           ok: ['/nieve.html','/tamarindo.html'] },
  { q: 'consultorio de psicología infantil',           ok: ['/pulso.html','/gateo.html'] },
  { q: 'boutique de ropa de gala',                     ok: ['/pareo.html','/oxford.html'] },
  { q: 'venta de productos para diabéticos',           ok: ['/receta.html','/tendito.html'] },
  { q: 'tienda de café de especialidad',               ok: ['/espuma.html','/cafeteria.html'] },
  { q: 'venta de productos de belleza coreanos',       ok: ['/brillo.html','/tendito.html'] }
];
...
(async () => {
  ...
  fs.writeFileSync(path.join(__dirname, '..', 'clean-round2-results.json'),
