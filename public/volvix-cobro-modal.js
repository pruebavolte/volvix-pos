...
(function () {
        ...
        var realData = {
          ...
          items: items.map(function (i) {
            return {
              ...
              modifiers: i.modifiers || [], note: i.note || '', base_price: (i.base_price != null ? i.base_price : null),
              tax: 0
            };
          }),
  ...
  function setupCompletePayWrapper() {
    ...
    window.completePay = async function () {
      ...
      try {
        if (window.VolvixPlatform && (window.VolvixPlatform.kind === 'electron' || window.VolvixPlatform.kind === 'android') && window.VolvixPlatform.printTicket &&
            window.VolvixTicketCustomizer && window.VolvixTicketCustomizer.renderText) {
      ...
      try {
        ...
        var items = (window.CART && window.CART.length)
          ? window.CART.map(function (i) { return { id: i.id, code: i.code, name: i.name, price: i.price, qty: i.qty, modifiers: i.modifiers || [], note: i.note || '', base_price: (i.base_price != null ? i.base_price : null) }; })
