/* =================================================================
   ...
   Replaces simulated showToast() handlers in multipos-suite.html
...
(function () {
  ...
  window.mpOpenInventory = function () {
    window.open('/salvadorex-pos.html#inventory', '_blank');
  };
  window.mpOpenCustomers = function () {
    window.open('/salvadorex-pos.html#customers', '_blank');
  };
  window.mpOpenMenu = function () {
    window.open('/salvadorex-pos.html#products', '_blank');
  };
