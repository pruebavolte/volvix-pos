...
(function () {
  ...
  // ---------------------------------------------------------------------------
  // Page: volvix-owner-panel.html — PDF buttons + gateways section
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Pages: pos-corte.html / salvadorex-pos.html — Imprimir Corte Z
  // ---------------------------------------------------------------------------
  function setupCorteZ() {
    var isCorte = /pos-corte\.html?$/i.test(fileName);
    var isSalv = /salvadorex-pos\.html?$/i.test(fileName);
