...
async function searchGiros(ctx, req, res, parsedUrl) {
  ...
  if (hit) {
    ...
    const PLAIN_TO_PREMIUM = {
      ...
      // V9.0.5 additions (detected with agent-validator):
      '/landing-taqueria.html': '/comandero.html',
      '/landing-dental.html': '/pulso.html',
      '/landing-veterinaria.html': '/pata.html',
      ...
      '/landing-estetica.html': '/brillo.html',
      '/landing-spa.html': '/brillo.html',
      '/landing-gimnasio.html': '/forja.html',
      '/landing-gym.html': '/forja.html',
      '/landing-salon-belleza.html': '/brillo.html',
      '/landing-cafeteria.html': '/espuma.html',
      '/landing-panaderia.html': '/merengue.html',
      '/landing-restaurante.html': '/comandero.html',
      '/landing-bar.html': '/tarima.html',
      '/landing-antro.html': '/tarima.html',
      '/landing-discoteca.html': '/tarima.html',
      '/landing-mecanico.html': '/refacciona.html',
      '/landing-taller.html': '/refacciona.html',
      '/landing-lavanderia.html': '/burbuja.html',
      '/landing-tintoreria.html': '/burbuja.html',
      '/landing-carwash.html': '/burbuja.html',
      '/landing-veterinario.html': '/pata.html',
      '/landing-mascotas.html': '/pata.html',
      '/landing-petshop.html': '/pata.html',
      '/landing-renta.html': '/tarima.html',
      '/landing-eventos.html': '/tarima.html',
      '/landing-sushi.html': '/kappa.html',
      '/landing-pizzeria.html': '/comandero.html',
      '/landing-hamburguesas.html': '/grilla.html',
      '/landing-tienda-de-ropa.html': '/pareo.html',
      '/landing-zapatos.html': '/pareo.html',
      '/landing-electronicos.html': '/movil.html',
      '/landing-celulares.html': '/movil.html',
      '/landing-computadoras.html': '/torre.html',
      '/landing-juguetes.html': '/trompito.html',
      '/landing-jugueteria.html': '/trompito.html',
      '/landing-libros.html': '/bloque.html',
      '/landing-jardineria.html': '/folio.html',
      '/landing-construccion.html': '/folio.html',
      '/landing-plomeria.html': '/folio.html',
      '/landing-electricidad.html': '/watt.html',
      '/landing-contador.html': '/folio.html',
      '/landing-abogado.html': '/folio.html',
      '/landing-notaria.html': '/folio.html',
      '/landing-imprenta.html': '/folio.html',
      '/landing-fotografia.html': '/folio.html',
      '/landing-foto.html': '/folio.html',
      '/landing-funebres.html': '/folio.html',
      '/landing-hotel.html': '/folio.html',
      '/landing-motel.html': '/folio.html',
      '/landing-cerrajeria.html': '/folio.html',
      '/landing-fumigacion.html': '/folio.html',
      '/landing-mudanzas.html': '/folio.html',
      '/landing-sexshop.html': '/discreto.html',
      '/landing-erotic.html': '/discreto.html',
      '/landing-tatuaje.html': '/brillo.html',
      '/landing-vapeshop.html': '/discreto.html',
