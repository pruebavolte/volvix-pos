...
out["subsystems"] = [
  ...
  {"name":"Owner Panel","html":"volvix-owner-panel.html","role_required":"owner","public":False,"purpose":"Dueño de UN negocio individual"},
  {"name":"SalvadoreX POS","html":"salvadorex-pos.html","role_required":"cashier|manager|owner","public":False,"purpose":"Punto de venta"},
  {"name":"MultiPOS Suite","html":"multipos-suite.html","role_required":"manager","public":False,"purpose":"Multi-sucursal"},
