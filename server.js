...
// ============================================================
const CONFIG = {
  host: process.env.HOST || (process.env.RAILWAY_ENVIRONMENT ? '0.0.0.0' : 'localhost'),
  preferredPort: process.env.RAILWAY_ENVIRONMENT ? 8080 : (parseInt(process.env.PORT) || 3000),
